...
// import * as wms from 'wms/wmsDatabase.js';
...
//         if (totalLocQty === undefined) {
//             throw ({ reason: `locInv: ${upc} does have qty on location exclude WMS.` })
//         }
...
//             throw ({ reason: `locationInv: unable to get loc qty for upc ${upc}` })
//         }
//     }
